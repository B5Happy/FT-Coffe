...
contract SupplyChain is ConsumerRole, DistributorRole, FarmerRole, RetailerRole {
   ...
   string memory _originFarmLongitude, string memory  _productNotes) public
  {
    ...
    items[sku].upc = _upc;
    items[sku].originFarmerID = _originFarmerID;
    items[sku].originFarmName = _originFarmName;
    items[sku].originFarmInformation = _originFarmInformation;
    items[sku].originFarmLatitude = _originFarmLatitude;
    items[sku].originFarmLongitude = _originFarmLongitude;
  ...
  // Call modifer to check if buyer is the farmer
  onlyFarmer()
  ...
  function buyItem(uint _upc) public payable
    // Call modifier to check if upc has passed previous supply chain stage
    forSale(_upc)
    // Call modifer to check if buyer is the distributor
    onlyDistributor()
  ...
  function receiveItem(uint _upc) public
    // Call modifer to check if buyer is the retailer
    onlyRetailer()
    // Call modifier to check if upc has passed previous supply chain stage
    shipped(_upc)
  ...
  function purchaseItem(uint _upc) public
    // Call modifer to check if buyer is the consumer
    onlyConsumer()
    // Call modifier to check if upc has passed previous supply chain stage
    received(_upc)
    // Access Control List enforced by calling Smart Contract / DApp
